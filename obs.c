...
int MUL = 1, RDIV = 2, DIV = 3, MOD = 4, AND = 5, //MulOperator = "*" | "/" | DIV | MOD | "&".
    ...
    ARROW = 17, PERIOD = 18,
    CHAR = 20, INT = 21, REAL = 22, FALS = 23, TRU = 24, NILL = 25, STRING = 26, NOT = 27, LPAREN = 28, LBRAK = 29, LBRACE = 30, IDENT = 31, //factor = number | string | NIL | TRUE | FALSE | set | designator [ActualParameters] | "(" expression ")" | "~" factor.

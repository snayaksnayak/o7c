...
int MUL = 1, RDIV = 2, DIV = 3, MOD = 4, AND = 5,
    PLUS = 6, MINUS = 7, OR = 8, EQL = 9, NEQ = 10,
    LSR = 11, LEQ = 12, GTR = 13, GEQ = 14, IN = 15,
    IS = 16, ARROW = 17, PERIOD = 18, CHAR = 20,
    INT = 21, REAL = 22, FALS = 23, TRU = 24, NILL = 25,
    STRING = 26, NOT = 27, LPAREN = 28, LBRAK = 29, LBRACE = 30,
    IDENT = 31, IF = 32, WHILE = 34, REPEAT = 35,
    CASE = 36, FOR = 37, COMMA = 40,
    COLON = 41, BECOMES = 42, UPTO = 43, RPAREN = 44, RBRAK = 45,
    RBRACE = 46, THEN = 47, OF = 48, DO = 49, TO = 50,
    BY = 51, SEMICOLON = 52, END = 53, BAR = 54, ELSE = 55,
